...
namespace NeuroSpeech.Eternity
{
    ...
    public class EternityContextOld
    {
        ...
        private IWorkflow GetWorkflowInstance(Type type, string id, DateTimeOffset eta)
        {
            ...
            w.Init(id, (this as object as EternityContext)!, eta, type.GetCustomAttribute<GeneratedWorkflowAttribute>() != null );
            return w;
        }
